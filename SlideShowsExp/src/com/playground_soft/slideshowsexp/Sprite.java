...
public class Sprite {
	...
	private Sprite(Bitmap bitmap) {
		this.texture = loadTexture(bitmap);
	...
	public void draw() {
		...
		int textureHandler = GLES20.glGetUniformLocation(program, "s_texture");
	...
	private static int loadTexture(Bitmap bitmap) {
		...
		Bitmap bitmap2 = Bitmap.createScaledBitmap(bitmap, 2048, 1024, true);
